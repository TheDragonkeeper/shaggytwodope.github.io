        ...
        for a in soup.findAll('a', href=True):
            ...
            if link.startswith("http"):
                ...
                if link in invalid_list:
                    print("Web site does not exist, error:{}, link:{}".format(
                        invalid_list[link], link))

            # If it's a internal link, check the whole html page to see if the name or
            # class can be find or not
